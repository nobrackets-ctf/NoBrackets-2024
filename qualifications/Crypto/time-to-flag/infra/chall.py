...
FLAG = "NBCTF{a6f2c7bfc0dbe15cb4f6bbf1a99a499f}".encode('utf-8')
LOG_MAX = 128
MAX = 2**LOG_MAX
DIM = 8
...
class PRNG:
	def __init__(self):
		self.secret = [randint(1, MAX) for _ in range(DIM)]
...
print("Hello ! Bienvenue sur mon PRNG super sécurisé :)")
print("Commandes disponibles :")
print("`a`: recevoir un nombre aléatoire")
print("`f`: recevoir le flag chiffré avec ma seed introuvable !")
print("`q`: quitter")
