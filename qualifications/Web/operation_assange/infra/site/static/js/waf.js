...
function validateForm(event) {
    ...
    if (!usernameField.checkValidity() || !messageField.checkValidity()) {
        isValid = false;
    }
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    if (contactForm) {
        ...
        contactForm.addEventListener('preview', validateForm);
    }
});
